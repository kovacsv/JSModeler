...
JSM.BSPTree.prototype =
{
	...
	AddPolygonToNode : function (node, polygon, userData)
	{
	...
	AddInsidePolygonsToNode : function (node, polygons, userData)
	{
		if (node.inside === null) {
	...
	AddOutsidePolygonsToNode : function (node, polygons, userData)
	{
